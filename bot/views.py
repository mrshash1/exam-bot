...
• 🖼 در حالت سایت، دکمهٔ «⛶ تمام‌صفحه» هم هست و آزمون بدون نوار آدرس و تمام‌صفحه اجرا می‌شود.
...
<b>🧾 ثبت نتیجه با کد (سایت/مرورگر):</b>
• کد نتیجه را هر کسی می‌تواند برای ربات بفرستد — حتی خود دبیر؛ نتیجه به‌نام همان دانش‌آموزی که داخل کد است ثبت و نمایش داده می‌شود.
• اگر کد را دوباره بفرستی، نتیجه دوباره نمایش داده می‌شود (دفعات مجاز کم نمی‌شود).
