...
3️⃣ سوالات را بفرست — متن پیام یا فایل <code>txt</code>. (نمونه قالب را با دکمه‌ی «نمونه قالب» ببین)
4️⃣ «✅ انتشار آزمون» را بزن. لینک سایت و اپ همان‌جا داده می‌شود.

<b>حالت‌های برگزاری:</b>
✍️ <b>متنی</b>: سوالات داخل چت با دکمه مطرح می‌شود و تایمر رعایت می‌شود.
📱 <b>اپ</b>: دکمه‌ی «حالت اپ» صفحه آزمون را داخل خود تلگرام باز می‌کند — با <b>تایمر متحرک زنده</b>.
🌐 <b>سایت</b>: لینک گیت‌هاب‌پیج؛ آزمون در مرورگر با تایمر زنده اجرا می‌شود.

<b>🎯 برای دانش‌آموز:</b>
• روی لینک دبیر بزن یا کد آزمون را بفرست (یا «🎯 شرکت در آزمون»).
• بعد از پایان، نتیجه داخل چت ثبت و کارت نمره را می‌بینی.
• در حالت سایت/اپ، در پایان دکمه‌ی «ارسال نتیجه به ربات» نمره را ثبت می‌کند.
